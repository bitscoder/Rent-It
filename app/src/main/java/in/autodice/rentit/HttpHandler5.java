...
public class HttpHandler5 extends AsyncTask<String,String,String>
{
    Context context;
    ...
    HttpHandler5(Activity a,Context ctx, ArrayList<Product> productArrayList, GridView gridView)
    {
        context = ctx;
    ...
    protected String doInBackground(String... strings)
    {
        ...
        try        {
            url = new URL(baseurl + "viewfprod.php");
            connection = (HttpURLConnection) url.openConnection();
            connection.setDoOutput(true);
            connection.setDoInput(true);outputStream = connection.getOutputStream();
    ...
    protected void onPostExecute(String s)
    {
        ...
        try
        {
            ...
            customadapter2 adapter = new customadapter2( arrayList, activity);
