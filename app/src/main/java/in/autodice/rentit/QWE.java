...
public class QWE extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qwe);
        ...
        HttpHandler3 handler = new HttpHandler3("qwe", QWE.this, name, price, gender, category, size, locality, desc, imageView, orderid, soldto);
        handler.execute(id);
    }
}
